...
void CMenus::RenderSettingsInfClassControls(CUIRect MainView)
{
	...
	// Report location settings
	{
		...
		UiDoGetButtons(LastButton, LastButton + LocationKeys, ReportLocationSettings, MainView);
	...
	// Report location clearsettings
	{
		...
		UiDoGetButtons(LastButton, LastButton + LocationKeys, ReportLocationClearSettings, MainView);
		LastButton += LocationKeys;
	}

	{
		...
		UiDoGetButtons(LastButton, LastButton + TeamChatKeys, TeamChatSettings, MainView);
...

	{
		...
		UiDoGetButtons(LastButton, LastButton + ExtraCommandKeys, ExtraCommandsSettings, MainView);
