...
void CInfCBinds::OnConsoleInit()
{
	...
	Console()->Register("infc_dump_binds", "?s[key]", CFGFLAG_CLIENT, ConDumpBinds, this, "Print command executed by this keybindind or all binds");
...
bool CInfCBinds::OnInput(IInput::CEvent Event)
{
